...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheBooksList.onTable().iCheckColumns(undefined, {"ID":{"header":"ID"},"title":{"header":"title"},"category":{"header":"category"},"price":{"header":"price"},"currency":{"header":"currency"},"status":{"header":"status"}});
