#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""S/4HANA 日本語実習サイト固有のチェック（tools/build_pages.py の実行後に実行します）。
...
PAGES = ['index.html', 'prep.html', 'fi.html', 'co.html', 'mm.html', 'pp.html', 'sd.html',
         'tcode.html', 'glossary.html', 'issues.html', 'tasks.html', 'instructor.html', 'worksheet.html', 'quiz.html']
...
infos.append(f'quiz: {n_q} 問、解答は選択肢と一致、すべてに解説あり')
