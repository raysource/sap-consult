#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""work/site_model.json から S/4HANA 日本語実習サイトの全ページを生成します。
...
After a rebuild, re-run the verifiers:
        ...
        python3 tools/verify_site_jp.py
"""
import os
import sys
import importlib
...
def main():
    ...
    json.dump({'n_pages': len(pages), 'n_steps': st['steps'], 'figs': st['shots'],
               'n_cfg': 0, 'has_wbs': True, 'note': 'S/4HANA 日本語実習サイト：実機スクリーンショットのサイト（生成 SVG ではありません）'},
