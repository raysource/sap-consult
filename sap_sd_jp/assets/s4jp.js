...
(function () {
  ...
  function initFilter() {
    ...
    function apply() {
      ...
      if (count) count.textContent = "照会 " + n + " / " + rows.length + " 件のタスク";
    }
